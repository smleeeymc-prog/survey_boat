...
// 깊이 상한을 40으로 올리면서 같이 올렸다. 깊이 40이면 카메라가 29 단위를 가야 하는데
// 4.2초에 맞추면 7 u/s — 예전에 '너무 빠르다'고 했던 그 속도로 돌아간다. 5.5초면 5.3 u/s다.
export const CAM_TRAVEL_MAX_SEC = 5.5;
...
export const ARRIVAL_DEPTH_MAX = 40;
